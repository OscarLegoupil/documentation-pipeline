::: {custom-style="Title"}
Hand-authored fixture --- maintenance style sample --- Incomplete draft
:::
...
Incomplete draft. Only completed, validated and reviewed subsystem chapters are included. Final synthesis and strict final-export checks remain separate. Visual QA: pending. Human approval: not assigned.

# Contents

[1 Subsystem progress](#subsystem-progress)
...
# 1 Subsystem progress

Incomplete draft --- progress at the recorded source snapshot. A completed chapter is not approval of the entire repository document.
...
Pending or blocked chapters are omitted. Coverage later in this draft describes the whole recorded scope, including work outside the included chapters.
...
Review context records: 0 fresh; 1 same-context. Context provenance is reported, not independently proven by scripts.
